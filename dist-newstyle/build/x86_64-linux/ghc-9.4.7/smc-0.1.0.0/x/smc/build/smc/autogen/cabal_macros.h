...
/* package smc-0.1.0.0 */
#ifndef VERSION_smc
#define VERSION_smc "0.1.0.0"
#endif /* VERSION_smc */
#ifndef MIN_VERSION_smc
#define MIN_VERSION_smc(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_smc */
...
#define CURRENT_COMPONENT_ID "smc-0.1.0.0-inplace-smc"
